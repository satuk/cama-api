INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (1, 'Aura', 'Bleicherweg 5', 'Zurich', 8001, 'AURA Restaurant, Bar & Smoker''s Lounge, Eventsaal', 'https://www.aura-zurich.ch/', 'https://www.aura-event.ch/wp-content/uploads/2015/09/footer75_aura1.png', {ts '2017-01-01'});
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (2, 'Metropol', 'Fraumunsterstrasse 12', 'Zurich', 8001, 'Metropol Restaurant & Café /Bar', 'http://metropol-restaurant.ch/', 'http://www.metropol-restaurant.ch/wp-content/uploads/2017/04/metropol_logo-300x72.png', {ts '2017-01-01'});
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (3, 'Candrian AG', 'Bahnhofpl. 15', 'Zurich', 8001, 'Candrian Catering', 'http://www.candriancatering.ch', 'http://www.candriancatering.ch/redesign3/Bilder/candrian_home_01.png', {ts '2017-01-01'});
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (4, 'Mangosteen', 'Neumühlequai 42', 'Zurich', 8006, 'Mangosteen Catering - Zürich Marriott Hotel', 'https://www.mangosteen.ch', 'https://www.mangosteen.ch/wp-content/uploads/sites/7/2016/06/logo-mangosteen-2016.png', {ts '2017-01-01'});
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (5, 'Patata', 'Theaterspektakel 2015 - Landiwiese', 'Zurich', 8000, 'Beiz mit Chich und Schale', 'http://www.patata.ch', 'http://www.patata.ch/images/Patata-Logo.png', {ts '2017-01-01'});
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, date_created) VALUES (6, 'Edelweiss Catering', 'Bahnhofstrasse 100', 'Zurich', 8000, 'Eventmanagement-Firma', 'http://www.edelweiss-catering.ch/', 'http://www.edelweisscatering.ch/wp-content/uploads/2015/03/edelweiss_catering_def.png', {ts '2017-01-01'});
