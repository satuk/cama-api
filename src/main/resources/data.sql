...
INSERT INTO companies (id, name, address, city, postal_code, description, url, logo, public_events, date_created)
VALUES (7, 'Gamma Catering', 'Bösch 43', 'Hünenberg', 6331, 'GAMMA BRINGTS', 'http://www.gammacatering.com/', 'http://www.gammacatering.com/site/wp-content/uploads/2014/04/superslice_neg_gr-323x323.png', true, {ts '2017-01-01'});
...
INSERT INTO users (id, first_name, last_name, password, email, address, age, postal_code, handy_number, city, date_created) VALUES (4, 'Simona', 'Mühlebach', 'password', 'simona@muster.ch', 'Bahnhofstrasse 100', 55, 8000, 0790000000, 'Zürich', {ts '2017-01-01 00:00:00.00'});
INSERT INTO users (id, first_name, last_name, password, email, address, age, postal_code, handy_number, city,
...
', 'http://zuerich.usgang.ch/uploadfile/flyer/752716.jpg', {ts '2017-01-01'}, {ts '2017-01-01 12:00:00.00'}, {ts '2017-01-01 23:00:00.00'}, 0, 400, 1,'Reggaeton und RnB',{ts '2017-01-01'}, true );
...
INSERT INTO events (id, name, logo, date, start, end, different_location, expected_person, company_id,  description,date_created, visibility) VALUES (5, 'Liondary - By Lion Lifestyle', 'https://www.aura-club.ch/wp-content/uploads/2017/06/1000x100_Liondary_15.07.17.jpg', {ts '2017-07-15'}, {ts '2017-07-15 22:00:00.00'}, {ts '2017-07-16 04:00:00.00'}, 0, 1000, 4,'-Club Summer Break-', {ts '2017-07-13'}, true );
INSERT INTO events (id, name, logo, date, start, end, different_location, expected_person, company_id,  description,date_created, visibility) VALUES (6, 'Summer Break', 'https://www.aura-club.ch/wp-content/uploads/2016/07/ICON_Summer_Closing.jpg', {ts '2017-07-22'}, {ts '2017-07-22 22:00:00.00'}, {ts '2017-07-23 04:00:00.00'}, 0, 500, 6,'-Club Summer Break-', {ts '2017-07-13'}, true );
